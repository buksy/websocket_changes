...
public abstract class WebSocket {
	 ...
	 * @throws IOException 
	 */
	public abstract void send( String text ) throws NotYetConnectedException, IOException;
	 ...
	 * @throws IOException 
	 */
	public abstract void send( ByteBuffer bytes ) throws IllegalArgumentException , NotYetConnectedException , InterruptedException, IOException;

	public abstract void send( byte[] bytes ) throws IllegalArgumentException , NotYetConnectedException , InterruptedException, IOException;

	public abstract void sendFrame( Framedata framedata ) throws IOException;
	...
	public abstract void startHandshake( ClientHandshakeBuilder handshakedata ) throws InvalidHandshakeException , InterruptedException, IOException;
	...
	public abstract boolean read(ByteBuffer buff) throws IOException;
	
	public abstract void decode( ByteBuffer socketBuffer ) throws IOException;
